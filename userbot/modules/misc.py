...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Pakdhe-Usbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Pakdhe-Usbot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Mengulang Kembali Pakdhe-Usbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Pakdhe-Usbot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Pakdhe-Usbot Repo](https://github.com/OMNIPOT/Lord-Userbot)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "🔥 **Repo Userbot:** [Pakdhe-Usbot](https://github.com/OMNIPOT/Lord-Userbot)\n🔥 **Pengubah:** [Ardian](t.me/Establishedd)"
    )
