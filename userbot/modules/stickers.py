...
KANGING_STR = [
    "Menambahkan Sticker Ini Ke Koleksi Pakdhe",
    "Pakdhe Menambahkan Sticker Ini Ke Pack",
]
...
async def kang(args):
    ...
    if message and message.media:
        if isinstance(message.media, MessageMediaPhoto):
            ...
            return await args.edit("`File Tidak Didukung Pak!`")
    else:
        return await args.edit("`Maaf Pakdhe, Saya Gagal Mengambil Sticker Ini!`")
    ...
    if photo:
        ...
        if (
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            "\nIni pack yang baru saja Pakdhe buat!"
                            f"\nTekan [Koleksi Pakdhe](t.me/addstickers/{packname}) Untuk Melihat Sticker Pakdhe",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Maaf Pakdhe, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker Anda.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Mohon Maaf Lahir Dan Batin, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack, Tekan** **[Koleksi Pakdhe](t.me/addstickers/{packname})** **Untuk Melihat Pack Anda**",
            parse_mode="md",
        )
...
async def sticker_to_png(sticker):
    ...
    try:
        ...
        await sticker.edit("`Maaf Pakdhe, Ini Bukanlah Sticker`")
        return
